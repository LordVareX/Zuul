...
public:
  ...
  GetFleetRoleCredentialsRequest(const GetFleetRoleCredentialsRequest &other) {
    *this = other;
  }

  GetFleetRoleCredentialsRequest(
      GetFleetRoleCredentialsRequest &&other) noexcept {
    *this = std::move(other);
  }

  GetFleetRoleCredentialsRequest &
  operator=(const GetFleetRoleCredentialsRequest &other) = default;

  GetFleetRoleCredentialsRequest &
  operator=(GetFleetRoleCredentialsRequest &&other) noexcept {
  ...
  inline const std::string &GetRoleSessionName() const {
    return m_roleSessionName;
  }

  inline void SetRoleSessionName(const std::string &value) {
    m_roleSessionName = value;
  }

  inline void SetRoleSessionName(std::string &&value) {
    m_roleSessionName = std::move(value);
  }

  inline void SetRoleSessionName(const char *value) {
    m_roleSessionName.assign(value);
  }

  inline GetFleetRoleCredentialsRequest &
  WithRoleSessionName(const std::string &value) {
    SetRoleSessionName(value);
    return *this;
  }

  inline GetFleetRoleCredentialsRequest &
  WithRoleSessionName(std::string &&value) {
    SetRoleSessionName(std::move(value));
    return *this;
  }

  inline GetFleetRoleCredentialsRequest &
  WithRoleSessionName(const char *value) {
    SetRoleSessionName(value);
    return *this;
  }
...
public:
  ...
  GetFleetRoleCredentialsRequest &
  operator=(const GetFleetRoleCredentialsRequest &other) {
    strncpy(m_roleArn, other.m_roleArn, sizeof(m_roleArn));
    strncpy(m_roleSessionName, other.m_roleSessionName,
            sizeof(m_roleSessionName));
