 ...
 *
 * Note: Each StartMatchBackfillRequest takes a little less than 1mb of memory.
 * The default windows stack size is 1mb, so creating one
 * StartMatchBackfillRequest variable on the stack frame gets you 99% of the way
 * to a stack overflow. On MacOS and Linux the stack size is up to 8mb so the
 * issue is seen less often but is still possible. Avoid creating local
...
public:
  ...
  StartMatchBackfillRequest(const StartMatchBackfillRequest &other)
      : m_ticketId(other.m_ticketId),
        ...
        m_gameSessionArn(other.m_gameSessionArn), m_players(other.m_players) {}
  ...
  StartMatchBackfillRequest &operator=(StartMatchBackfillRequest &&other) {
    ...
    m_matchmakingConfigurationArn =
        std::move(other.m_matchmakingConfigurationArn);
  ...
  inline StartMatchBackfillRequest &WithTicketId(const std::string &value) {
    SetTicketId(value);
    return *this;
  }

  inline StartMatchBackfillRequest &WithTicketId(std::string &&value) {
    SetTicketId(value);
    return *this;
  }

  inline StartMatchBackfillRequest &WithTicketId(const char *value) {
    SetTicketId(value);
    return *this;
  }

  inline const std::string &GetMatchmakingConfigurationArn() const {
    return m_matchmakingConfigurationArn;
  }

  inline void SetMatchmakingConfigurationArn(const std::string &value) {
    m_matchmakingConfigurationArn = value;
  }

  inline void SetMatchmakingConfigurationArn(std::string &&value) {
    m_matchmakingConfigurationArn = value;
  }

  inline void SetMatchmakingConfigurationArn(const char *value) {
    m_matchmakingConfigurationArn.assign(value);
  }

  inline StartMatchBackfillRequest &
  WithMatchmakingConfigurationArn(const std::string &value) {
    SetMatchmakingConfigurationArn(value);
    return *this;
  }

  inline StartMatchBackfillRequest &
  WithMatchmakingConfigurationArn(std::string &&value) {
    SetMatchmakingConfigurationArn(value);
    return *this;
  }

  inline StartMatchBackfillRequest &
  WithMatchmakingConfigurationArn(const char *value) {
    SetMatchmakingConfigurationArn(value);
    return *this;
  }

  inline const std::string &GetGameSessionArn() const {
    return m_gameSessionArn;
  }

  inline void SetGameSessionArn(const std::string &value) {
    m_gameSessionArn = value;
  }

  inline void SetGameSessionArn(std::string &&value) {
    m_gameSessionArn = value;
  }

  inline void SetGameSessionArn(const char *value) {
    m_gameSessionArn.assign(value);
  }

  inline StartMatchBackfillRequest &
  WithGameSessionArn(const std::string &value) {
    SetGameSessionArn(value);
    return *this;
  }

  inline StartMatchBackfillRequest &WithGameSessionArn(std::string &&value) {
    SetGameSessionArn(value);
    return *this;
  }

  inline StartMatchBackfillRequest &WithGameSessionArn(const char *value) {
    SetGameSessionArn(value);
    return *this;
  }
  ...
  inline void SetPlayers(const std::vector<Player> &value) {
    m_players = value;
  }
  ...
  inline StartMatchBackfillRequest &
  WithPlayer(const std::vector<Player> &value) {
    SetPlayers(value);
    return *this;
  }

  inline StartMatchBackfillRequest &WithPlayer(std::vector<Player> &&value) {
    SetPlayers(value);
    return *this;
  }

  inline StartMatchBackfillRequest &AddPlayer(const Player &value) {
    m_players.push_back(value);
    return *this;
  }

  inline StartMatchBackfillRequest &AddPlayer(Player &&value) {
    m_players.push_back(value);
    return *this;
  }
...
#else
public:
  StartMatchBackfillRequest() : m_playerCount(0) {
    memset(m_ticketId, 0, sizeof(m_ticketId));
    memset(m_matchmakingConfigurationArn, 0,
           sizeof(m_matchmakingConfigurationArn));
  ...
  inline void SetTicketId(const char *value) {
    strncpy(m_ticketId, value, sizeof(m_ticketId));
    m_ticketId[MAX_TICKET_LENGTH - 1] = '\0';
  }
  ...
  inline const char *GetMatchmakingConfigurationArn() const {
    return m_matchmakingConfigurationArn;
  }

  inline void SetMatchmakingConfigurationArn(const char *value) {
    strncpy(m_matchmakingConfigurationArn, value,
            sizeof(m_matchmakingConfigurationArn));
  ...
  inline const Player *GetPlayers(int &count) const {
    count = m_playerCount;
    return m_players;
  }

  inline StartMatchBackfillRequest &AddPlayer(const Player &player) {
  ...
  inline StartMatchBackfillRequest &WithPlayer(Player player) {
