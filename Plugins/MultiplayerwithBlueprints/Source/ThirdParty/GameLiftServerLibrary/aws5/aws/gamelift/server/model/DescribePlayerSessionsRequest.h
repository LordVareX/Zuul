...
public:
  ...
  DescribePlayerSessionsRequest(const DescribePlayerSessionsRequest &other)
      : m_gameSessionId(other.m_gameSessionId), m_playerId(other.m_playerId),
        m_playerSessionId(other.m_playerSessionId),
        m_playerSessionStatusFilter(other.m_playerSessionStatusFilter),
        m_limit(other.m_limit), m_nextToken(other.m_nextToken) {}
   ...
   */
  DescribePlayerSessionsRequest &
  operator=(const DescribePlayerSessionsRequest &other) {
   ...
   */
  DescribePlayerSessionsRequest &
  operator=(DescribePlayerSessionsRequest &&other) {
   ...
   * string&gt;". The value of &lt;ID string&gt; is either a custom ID string
   * (if one was specified when the game session was created) an auto-generated
   * string. </p>
   */
   ...
   * string. </p>
   */
  inline DescribePlayerSessionsRequest &
  WithGameSessionId(const std::string &value) {
   ...
   */
  inline DescribePlayerSessionsRequest &
  WithPlayerSessionId(const std::string &value) {
   ...
   */
  inline DescribePlayerSessionsRequest &
  WithPlayerSessionId(std::string &&value) {
    SetPlayerSessionId(value);
    return *this;
  }
  ...
  /**
   * <p>Player session status to filter results on.</p> <p>Possible player
   * session statuses include the following:</p> <ul> <li> <p> <b>RESERVED</b> –
   ...
   * </li> <li> <p> <b>COMPLETED</b> – The player connection has been
   * dropped.</p>
   * </li> <li> <p> <b>TIMEDOUT</b> – A player session request was received, but
   * the player did not connect and/or was not validated within the time-out
   * limit (60 seconds).</p> </li> </ul>
   */
  inline const std::string &GetPlayerSessionStatusFilter() const {
   ...
   * limit (60 seconds).</p> </li> </ul>
   */
  inline void SetPlayerSessionStatusFilter(const std::string &value) {
    m_playerSessionStatusFilter = value;
  }
   ...
   * limit (60 seconds).</p> </li> </ul>
   */
  inline void SetPlayerSessionStatusFilter(std::string &&value) {
    m_playerSessionStatusFilter = value;
  }
  ...
  inline void SetPlayerSessionStatusFilter(const char *value) {
    m_playerSessionStatusFilter.assign(value);
  }
   ...
   */
  inline DescribePlayerSessionsRequest &
  WithPlayerSessionStatusFilter(const std::string &value) {
   ...
   */
  inline DescribePlayerSessionsRequest &
  WithPlayerSessionStatusFilter(std::string &&value) {
    SetPlayerSessionStatusFilter(value);
    return *this;
  }
   ...
   */
  inline DescribePlayerSessionsRequest &
  WithPlayerSessionStatusFilter(const char *value) {
    SetPlayerSessionStatusFilter(value);
    return *this;
  }
   ...
   * player session ID is specified, this parameter is ignored.</p>
   */
  ...
  /**
   * <p>Token indicating the start of the next sequential page of results. Use
   * the token that is returned with a previous call to this action. To specify
   * the start of the result set, do not specify a value. If a player session ID
   ...
   */
  inline DescribePlayerSessionsRequest &
  WithNextToken(const std::string &value) {
    SetNextToken(value);
    return *this;
  }
...
public:
  ...
  DescribePlayerSessionsRequest(const DescribePlayerSessionsRequest &other)
    ...
    strncpy(m_playerSessionStatusFilter, other.m_playerSessionStatusFilter,
            sizeof(other.m_playerSessionStatusFilter));
  ...
  operator=(DescribePlayerSessionsRequest &&other) {
    ...
    memset(other.m_playerSessionStatusFilter, 0,
           sizeof(other.m_playerSessionStatusFilter));
   ...
   * limit (60 seconds).</p> </li> </ul>
   */
  inline const char *GetPlayerSessionStatusFilter() const {
    return m_playerSessionStatusFilter;
  }
   ...
   */
  inline void SetPlayerSessionStatusFilter(const char *value) {
    strncpy(m_playerSessionStatusFilter, value,
            sizeof(m_playerSessionStatusFilter));
