...
namespace Internal {
/**
 * WebSocketDescribePlayerSessionsRequest Response. This response is sent to the
...
public:
  ...
  WebSocketDescribePlayerSessionsResponse(
      const WebSocketDescribePlayerSessionsResponse &) = default;
  WebSocketDescribePlayerSessionsResponse(
      WebSocketDescribePlayerSessionsResponse &&) = default;
  WebSocketDescribePlayerSessionsResponse &
  operator=(const WebSocketDescribePlayerSessionsResponse &) = default;
  WebSocketDescribePlayerSessionsResponse &
  operator=(WebSocketDescribePlayerSessionsResponse &&) = default;
  ~WebSocketDescribePlayerSessionsResponse() = default;

  inline const std::string &GetNextToken() const { return m_nextToken; }

  inline const std::vector<WebSocketPlayerSession> &GetPlayerSessions() const {
  ...
  inline void
  SetPlayerSessions(const std::vector<WebSocketPlayerSession> &playerSessions) {
    m_playerSessions = playerSessions;
  }

  inline WebSocketDescribePlayerSessionsResponse &
  WithNextToken(const std::string &nextToken) {
    SetNextToken(nextToken);
    return *this;
  }

  inline WebSocketDescribePlayerSessionsResponse &WithPlayerSessions(
      const std::vector<WebSocketPlayerSession> &playerSessions) {
    SetPlayerSessions(playerSessions);
    return *this;
  }

  friend std::ostream &operator<<(std::ostream &os,
                                  const WebSocketDescribePlayerSessionsResponse
