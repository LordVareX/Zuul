...
public:
  ...
  ServerParameters(const std::string &websocketUrl,
                   const std::string &authToken, const std::string &fleetId,
                   const std::string &hostId, const std::string &processId)
      : m_webSocketUrl(websocketUrl), m_authToken(authToken),
        m_fleetId(fleetId), m_hostId(hostId), m_processId(processId) {}
  ...
  inline void SetWebSocketUrl(const std::string &webSocketUrl) {
  ...
  inline void SetProcessId(const std::string &processId) {
...
public:
  ...
  ServerParameters(const char *webSocketUrl, const char *authToken,
                   const char *fleetId, const char *hostId,
