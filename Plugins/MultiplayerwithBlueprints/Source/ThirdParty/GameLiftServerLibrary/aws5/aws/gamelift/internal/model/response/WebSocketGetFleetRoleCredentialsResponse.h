...
public:
  WebSocketGetFleetRoleCredentialsResponse() : m_expiration(-1) {
    SetAction(ACTION);
  };

  WebSocketGetFleetRoleCredentialsResponse(
      const WebSocketGetFleetRoleCredentialsResponse &) = default;

  WebSocketGetFleetRoleCredentialsResponse(
      WebSocketGetFleetRoleCredentialsResponse &&) = default;

  WebSocketGetFleetRoleCredentialsResponse &
  operator=(const WebSocketGetFleetRoleCredentialsResponse &) = default;

  WebSocketGetFleetRoleCredentialsResponse &
  operator=(WebSocketGetFleetRoleCredentialsResponse &&) = default;

  ~WebSocketGetFleetRoleCredentialsResponse() = default;

  inline const std::string &GetAssumedRoleUserArn() const {
    return m_assumedRoleUserArn;
  }

  inline void SetAssumedRoleUserArn(const std::string &assumedRoleUserArn) {
    m_assumedRoleUserArn = assumedRoleUserArn;
  }

  inline WebSocketGetFleetRoleCredentialsResponse &
  WithAssumedRoleUserArn(const std::string &assumedRoleUserArn) {
  ...
  inline void SetAssumedRoleId(const std::string &assumedRoleId) {
    m_assumedRoleId = assumedRoleId;
  }

  inline WebSocketGetFleetRoleCredentialsResponse &
  WithAssumedRoleId(const std::string &assumedRoleId) {
  ...
  inline void SetAccessKeyId(const std::string &accessKeyId) {
    m_accessKeyId = accessKeyId;
  }

  inline WebSocketGetFleetRoleCredentialsResponse &
  WithAccessKeyId(const std::string &accessKeyId) {
  ...
  inline void SetSecretAccessKey(const std::string &secretAccessKey) {
    m_secretAccessKey = secretAccessKey;
  }

  inline WebSocketGetFleetRoleCredentialsResponse &
  WithSecretAccessKey(const std::string &secretAccessKey) {
  ...
  inline void SetSessionToken(const std::string &sessionToken) {
    m_sessionToken = sessionToken;
  }

  inline WebSocketGetFleetRoleCredentialsResponse &
  WithSessionToken(const std::string &sessionToken) {
  ...
  inline WebSocketGetFleetRoleCredentialsResponse &
  WithExpiration(int64_t expiration) {
