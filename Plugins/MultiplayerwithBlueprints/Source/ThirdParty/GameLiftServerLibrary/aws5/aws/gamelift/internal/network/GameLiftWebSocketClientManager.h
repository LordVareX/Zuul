...
/**
 * Class Managing a single WebSocketClientWrapper, enabling connection and
 * communication with GameLift
 */
...
public:
  GameLiftWebSocketClientManager(
      ...
      : m_webSocketClientWrapper(webSocketClientWrapper) {}

  ~GameLiftWebSocketClientManager() = default;

  inline bool IsConnected() { return m_webSocketClientWrapper->IsConnected(); }

  Aws::GameLift::GenericOutcome Connect(std::string websocketUrl,
