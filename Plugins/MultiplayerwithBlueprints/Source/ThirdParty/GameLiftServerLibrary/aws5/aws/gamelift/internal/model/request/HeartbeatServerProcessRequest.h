...
public:
  HeartbeatServerProcessRequest() : m_healthy(true) {
    SetAction(HEARTBEAT_SERVER_PROCESS);
  };
  HeartbeatServerProcessRequest(const HeartbeatServerProcessRequest &) =
      default;
  HeartbeatServerProcessRequest(HeartbeatServerProcessRequest &&) = default;
  HeartbeatServerProcessRequest &
  operator=(const HeartbeatServerProcessRequest &) = default;
  HeartbeatServerProcessRequest &
  operator=(HeartbeatServerProcessRequest &&) = default;
  ...
  friend std::ostream &operator<<(
      std::ostream &os,
      const HeartbeatServerProcessRequest &HeartbeatServerProcessRequest);
...
private:
  static constexpr const char *HEARTBEAT_SERVER_PROCESS =
