...
/**
 * ActivateServerProcess Request. This request is sent to the GameLift WebSocket
 * during the ProcessReady call
 */
class ActivateServerProcessRequest : public Message {
public:
  ActivateServerProcessRequest();
  ActivateServerProcessRequest(
      std::string sdkVersion, std::string sdkLanguage, int port,
  ...
  ActivateServerProcessRequest &
  operator=(const ActivateServerProcessRequest &) = default;
  ActivateServerProcessRequest &
  operator=(ActivateServerProcessRequest &&) = default;
  ...
  inline const Aws::GameLift::Server::LogParameters GetLogParameters() const {
    return m_logParameters;
  }

  inline void SetSdkVersion(const std::string &sdkVersion) {
    m_sdkVersion = sdkVersion;
  }

  inline void SetSdkLanguage(const std::string &sdkLanguage) {
    m_sdkLanguage = sdkLanguage;
  }

  inline void SetPort(const int port) { m_port = port; }

  inline void
  SetLogParameters(const Aws::GameLift::Server::LogParameters &logParameters) {
  ...
  inline ActivateServerProcessRequest &
  WithLogParameters(const Aws::GameLift::Server::LogParameters &logParameters) {
    SetLogParameters(logParameters);
    return *this;
  }

  inline ActivateServerProcessRequest &
  WithSdkVersion(const std::string &sdkVersion) {
    SetSdkVersion(sdkVersion);
    return *this;
  }

  inline ActivateServerProcessRequest &
  WithSdkLanguage(const std::string &sdkLanguage) {
    SetSdkLanguage(sdkLanguage);
    return *this;
  }

  friend std::ostream &operator<<(std::ostream &os,
                                  const ActivateServerProcessRequest &request);
...
private:
  static constexpr const char *ACTIVATE_SERVER_PROCESS =
