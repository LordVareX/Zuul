...
public:
  ...
  WebSocketStopMatchBackfillRequest(const WebSocketStopMatchBackfillRequest &) =
      default;
  WebSocketStopMatchBackfillRequest(WebSocketStopMatchBackfillRequest &&) =
      default;
  WebSocketStopMatchBackfillRequest &
  operator=(const WebSocketStopMatchBackfillRequest &) = default;
  WebSocketStopMatchBackfillRequest &
  operator=(WebSocketStopMatchBackfillRequest &&) = default;
  ...
  inline WebSocketStopMatchBackfillRequest &WithMatchmakingConfigurationArn(
      const std::string &matchmakingConfigurationArn) {
    SetMatchmakingConfigurationArn(matchmakingConfigurationArn);
    return *this;
  }
  inline WebSocketStopMatchBackfillRequest &
  ...
  operator<<(std::ostream &os,
             const WebSocketStopMatchBackfillRequest &stopMatchBackfillMessage);
...
private:
  ...
  static constexpr const char *MATCHMAKING_CONFIG_ARN =
