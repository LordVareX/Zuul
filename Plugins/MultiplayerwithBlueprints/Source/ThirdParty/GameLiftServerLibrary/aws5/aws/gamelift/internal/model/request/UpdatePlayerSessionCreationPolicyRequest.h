...
enum class WebSocketPlayerSessionCreationPolicy {
  NOT_SET,
  DENY_ALL,
  ACCEPT_ALL
};
...
/**
 * UpdatePlayerSessionCreationPolicyRequest Request. This request is sent to the
...
public:
  ...
  UpdatePlayerSessionCreationPolicyRequest(
      std::string gameSessionId, std::string playerSessionCreationPolicy)
      : m_gameSessionId(std::move(gameSessionId)) {
    SetAction(ACTION);
    SetPlayerSessionCreationPolicy(playerSessionCreationPolicy);
  }

  UpdatePlayerSessionCreationPolicyRequest(
      const UpdatePlayerSessionCreationPolicyRequest &) = default;
  UpdatePlayerSessionCreationPolicyRequest(
      UpdatePlayerSessionCreationPolicyRequest &&) = default;
  UpdatePlayerSessionCreationPolicyRequest &
  operator=(const UpdatePlayerSessionCreationPolicyRequest &) = default;
  UpdatePlayerSessionCreationPolicyRequest &
  operator=(UpdatePlayerSessionCreationPolicyRequest &&) = default;
  ~UpdatePlayerSessionCreationPolicyRequest() = default;
  ...
  inline const WebSocketPlayerSessionCreationPolicy &
  GetPlayerSessionCreationPolicy() const {
  ...
  inline void SetPlayerSessionCreationPolicy(
      const WebSocketPlayerSessionCreationPolicy &playerSessionCreationPolicy) {
  ...
  inline void SetPlayerSessionCreationPolicy(
      const std::string &playerSessionCreationPolicy) {
    if (strcmp(playerSessionCreationPolicy.c_str(), ACCEPT_ALL) == 0) {
      m_playerSessionCreationPolicy =
          WebSocketPlayerSessionCreationPolicy::ACCEPT_ALL;
    } else if (strcmp(playerSessionCreationPolicy.c_str(), DENY_ALL) == 0) {
      m_playerSessionCreationPolicy =
          WebSocketPlayerSessionCreationPolicy::DENY_ALL;
    } else {
      m_playerSessionCreationPolicy =
          WebSocketPlayerSessionCreationPolicy::NOT_SET;
    }
  }
  ...
  friend std::ostream &operator<<(std::ostream &os,
                                  const UpdatePlayerSessionCreationPolicyRequest
