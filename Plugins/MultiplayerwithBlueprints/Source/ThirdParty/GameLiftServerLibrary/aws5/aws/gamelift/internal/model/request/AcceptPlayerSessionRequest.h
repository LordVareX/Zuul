...
public:
  ...
  AcceptPlayerSessionRequest(std::string gameSessionId,
  ...
  operator=(const AcceptPlayerSessionRequest &) = default;
  AcceptPlayerSessionRequest &
  operator=(AcceptPlayerSessionRequest &&) = default;
  ...
  inline AcceptPlayerSessionRequest &
  ...
  friend std::ostream &operator<<(std::ostream &os,
                                  const AcceptPlayerSessionRequest &request);
