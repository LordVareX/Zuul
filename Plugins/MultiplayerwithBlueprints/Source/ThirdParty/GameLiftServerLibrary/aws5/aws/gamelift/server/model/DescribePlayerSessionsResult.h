...
public:
   ...
   */
  DescribePlayerSessionsResult &
  operator=(const DescribePlayerSessionsResult &other) {
    m_playerSessions = other.m_playerSessions;
    m_nextToken = other.m_nextToken;
   ...
   */
  DescribePlayerSessionsResult &
  operator=(DescribePlayerSessionsResult &&other) {
   ...
   */
  inline const std::vector<PlayerSession> &GetPlayerSessions() const {
   ...
   * matches the request.</p>
   */
  inline void SetPlayerSessions(const std::vector<PlayerSession> &value) {
   ...
   * matches the request.</p>
   */
  inline void SetPlayerSessions(std::vector<PlayerSession> &&value) {
    m_playerSessions = value;
  }
   ...
   * matches the request.</p>
   */
  inline DescribePlayerSessionsResult &
  WithPlayerSessions(const std::vector<PlayerSession> &value) {
    SetPlayerSessions(value);
    return *this;
  }
   ...
   */
  inline DescribePlayerSessionsResult &
  WithPlayerSessions(std::vector<PlayerSession> &&value) {
    SetPlayerSessions(value);
    return *this;
  }
   ...
   */
  inline DescribePlayerSessionsResult &
  AddPlayerSession(const PlayerSession &value) {
    m_playerSessions.push_back(value);
    return *this;
  }
   ...
   * matches the request.</p>
   */
  inline DescribePlayerSessionsResult &AddPlayerSession(PlayerSession &&value) {
    m_playerSessions.push_back(value);
    return *this;
  }

  /**
   * <p>Token indicating where to resume retrieving results on the next call to
   ...
   * the list.</p>
   */
  inline DescribePlayerSessionsResult &WithNextToken(const std::string &value) {
    SetNextToken(value);
    return *this;
  }
   ...
   * the list.</p>
   */
  inline DescribePlayerSessionsResult &WithNextToken(std::string &&value) {
    SetNextToken(value);
    return *this;
  }
   ...
   * the list.</p>
   */
  inline DescribePlayerSessionsResult &WithNextToken(const char *value) {
    SetNextToken(value);
    return *this;
  }
...
public:
  ...
  DescribePlayerSessionsResult(const DescribePlayerSessionsResult &other)
    ...
    std::copy(std::begin(other.m_playerSessions),
              std::end(other.m_playerSessions), std::begin(m_playerSessions));
  }
   ...
   * matches the request.</p>
   */
  inline const PlayerSession *GetPlayerSessions(int &count) const {
    count = m_playerSessions_count;
    return m_playerSessions;
  }
   ...
   */
  inline DescribePlayerSessionsResult &
  WithPlayerSessions(PlayerSession playerSession) {
    AddPlayerSession(playerSession);
    return *this;
  }
