...
namespace Internal {
/**
 * WebSocketDescribePlayerSessionsRequest Request. This request is sent to the
...
public:
  ...
  WebSocketDescribePlayerSessionsRequest(
      const WebSocketDescribePlayerSessionsRequest &) = default;
  WebSocketDescribePlayerSessionsRequest(
      WebSocketDescribePlayerSessionsRequest &&) = default;
  WebSocketDescribePlayerSessionsRequest &
  operator=(const WebSocketDescribePlayerSessionsRequest &) = default;
  WebSocketDescribePlayerSessionsRequest &
  operator=(WebSocketDescribePlayerSessionsRequest &&) = default;
  ~WebSocketDescribePlayerSessionsRequest() = default;
  ...
  inline void SetPlayerId(const std::string &playerId) {
    m_playerId = playerId;
  }

  inline void SetPlayerSessionId(const std::string &playerSessionId) {
    m_playerSessionId = playerSessionId;
  }

  inline void
  SetPlayerSessionStatusFilter(const std::string &playerSessionStatusFilter) {
    m_playerSessionStatusFilter = playerSessionStatusFilter;
  }

  inline void SetNextToken(const std::string &nextToken) {
    m_nextToken = nextToken;
  }

  inline void SetLimit(const int limit) { m_limit = limit; }

  inline WebSocketDescribePlayerSessionsRequest &
  ...
  inline WebSocketDescribePlayerSessionsRequest &
  WithPlayerId(const std::string &playerId) {
    SetPlayerId(playerId);
    return *this;
  }

  inline WebSocketDescribePlayerSessionsRequest &
  WithPlayerSessionId(const std::string &playerSessionId) {
    SetPlayerSessionId(playerSessionId);
    return *this;
  }

  inline WebSocketDescribePlayerSessionsRequest &
  WithPlayerSessionStatusFilter(const std::string &playerSessionStatusFilter) {
    SetPlayerSessionStatusFilter(playerSessionStatusFilter);
    return *this;
  }

  inline WebSocketDescribePlayerSessionsRequest &
  WithNextToken(const std::string &nextToken) {
  ...
  friend std::ostream &operator<<(std::ostream &os,
                                  const WebSocketDescribePlayerSessionsRequest
...
private:
  ...
  static constexpr const char *PLAYER_SESSION_STATUS_FILTER =
