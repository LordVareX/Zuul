...
public:
  ...
  WebSocketGetComputeCertificateResponse(
      const WebSocketGetComputeCertificateResponse &) = default;
  WebSocketGetComputeCertificateResponse(
      WebSocketGetComputeCertificateResponse &&) = default;
  WebSocketGetComputeCertificateResponse &
  operator=(const WebSocketGetComputeCertificateResponse &) = default;
  WebSocketGetComputeCertificateResponse &
  operator=(WebSocketGetComputeCertificateResponse &&) = default;
  ~WebSocketGetComputeCertificateResponse() = default;
  ...
  inline WebSocketGetComputeCertificateResponse &
  WithComputeName(const std::string &computeName) {
  ...
  inline void SetCertificatePath(const std::string &certificatePath) {
    m_certificatePath = certificatePath;
  }

  inline WebSocketGetComputeCertificateResponse &
  WithCertificatePath(const std::string &certificatePath) {
    SetCertificatePath(certificatePath);
    return *this;
  }

  friend std::ostream &operator<<(std::ostream &os,
                                  const WebSocketGetComputeCertificateResponse
                                      &webSocketGetComputeCertificateResponse);
