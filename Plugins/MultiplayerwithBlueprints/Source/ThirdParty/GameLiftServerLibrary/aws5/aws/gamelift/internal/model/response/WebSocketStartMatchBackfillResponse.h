...
namespace Internal {
/**
 * WebSocketStartMatchBackfillRequest Response. This response is sent to the
...
public:
  ...
  WebSocketStartMatchBackfillResponse(
      const WebSocketStartMatchBackfillResponse &) = default;
  WebSocketStartMatchBackfillResponse(WebSocketStartMatchBackfillResponse &&) =
      default;
  WebSocketStartMatchBackfillResponse &
  operator=(const WebSocketStartMatchBackfillResponse &) = default;
  WebSocketStartMatchBackfillResponse &
  operator=(WebSocketStartMatchBackfillResponse &&) = default;
  ...
  inline WebSocketStartMatchBackfillResponse &
  ...
  friend std::ostream &operator<<(std::ostream &os,
                                  const WebSocketStartMatchBackfillResponse
