...
public:
  static Server::Model::DescribePlayerSessionsResult
  convert(const WebSocketDescribePlayerSessionsResponse *webSocketResponse);
  static WebSocketDescribePlayerSessionsRequest
  convert(const Server::Model::DescribePlayerSessionsRequest &request);
};
} // namespace Internal
} // namespace GameLift
} // namespace Aws