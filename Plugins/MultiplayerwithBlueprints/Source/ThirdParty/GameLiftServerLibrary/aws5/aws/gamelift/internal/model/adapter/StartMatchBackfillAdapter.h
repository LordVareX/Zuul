...
public:
  static Server::Model::StartMatchBackfillResult
  convert(const WebSocketStartMatchBackfillResponse *webSocketResponse);
  static WebSocketStartMatchBackfillRequest
  convert(const Server::Model::StartMatchBackfillRequest &request);
  static std::map<std::string, int>
  fetchAndConvertLatency(const Server::Model::Player &player);
  static std::map<std::string, WebSocketAttributeValue>
  fetchAndConvertAttributes(const Server::Model::Player &player);
  static std::vector<std::string>
  convertStringList(const Server::Model::AttributeValue &attributeValue);
  static std::map<std::string, double>
  convertStringDoubleMap(const Server::Model::AttributeValue &attributeValue);
};
} // namespace Internal
} // namespace GameLift
} // namespace Aws