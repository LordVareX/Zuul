...
public:
  ...
  WebSocketGetFleetRoleCredentialsRequest(
      const WebSocketGetFleetRoleCredentialsRequest &) = default;

  WebSocketGetFleetRoleCredentialsRequest(
      WebSocketGetFleetRoleCredentialsRequest &&) = default;

  WebSocketGetFleetRoleCredentialsRequest &
  operator=(const WebSocketGetFleetRoleCredentialsRequest &) = default;

  WebSocketGetFleetRoleCredentialsRequest &
  operator=(WebSocketGetFleetRoleCredentialsRequest &&) = default;
  ...
  inline WebSocketGetFleetRoleCredentialsRequest &
  WithRoleArn(const std::string &value) {
    SetRoleArn(value);
    return *this;
  }
