...
public:
  ...
  GameSession(const GameSession &other)
      : m_gameSessionId(other.m_gameSessionId), m_name(other.m_name),
        m_fleetId(other.m_fleetId),
        m_maximumPlayerSessionCount(other.m_maximumPlayerSessionCount),
        m_status(other.m_status), m_gameProperties(other.m_gameProperties),
        m_ipAddress(other.m_ipAddress), m_port(other.m_port),
        m_gameSessionData(other.m_gameSessionData),
        m_matchmakerData(other.m_matchmakerData), m_dnsName(other.m_dnsName) {}
  ...
  GameSession(GameSession &&other)
      : m_gameSessionId(std::move(other.m_gameSessionId)),
        m_name(std::move(other.m_name)), m_fleetId(std::move(other.m_fleetId)),
        m_maximumPlayerSessionCount(other.m_maximumPlayerSessionCount),
        m_status(std::move(other.m_status)),
        m_gameProperties(std::move(other.m_gameProperties)),
        m_ipAddress(std::move(other.m_ipAddress)), m_port(other.m_port),
  ...
  /**
   * <p>Descriptive label associated with a game session. Session names do not
   * need to be unique.</p>
   */
   ...
   */
  inline int GetMaximumPlayerSessionCount() const {
   ...
   */
  inline const std::vector<GameProperty> &GetGameProperties() const {
   ...
   * <p>Set of custom properties for the game session.</p>
   */
  inline void SetGameProperties(const std::vector<GameProperty> &value) {
    m_gameProperties = value;
  }

  /**
   * <p>Set of custom properties for the game session.</p>
   */
  inline void SetGameProperties(std::vector<GameProperty> &&value) {
    m_gameProperties = value;
  }
   ...
   */
  inline GameSession &
  WithGameProperties(const std::vector<GameProperty> &value) {
  ...
  /**
   * <p>IP address of the game session. To connect to a GameLift server process,
   ...
   */
  inline const std::string &GetGameSessionData() const {
   ...
   * <p>Custom data for the game session.</p>
   */
  inline void SetGameSessionData(const std::string &value) {
   ...
   * <p>Custom data for the game session.</p>
   */
  inline void SetGameSessionData(std::string &&value) {
    m_gameSessionData = value;
  }
  ...
  inline void SetGameSessionData(const char *value) {
    m_gameSessionData.assign(value);
  }
   ...
   */
  inline const std::string &GetMatchmakerData() const {
   ...
   * <p>Data generated from GameLift Matchmaking.</p>
   */
  inline void SetMatchmakerData(const std::string &value) {
    m_matchmakerData = value;
  }

  /**
   * <p>Data generated from GameLift Matchmaking.</p>
   */
  inline void SetMatchmakerData(std::string &&value) {
    m_matchmakerData = value;
  }
  ...
  /**
   * <p>The DNS name of the host running a GameLift server process, used for
   * establishing a TLS connection for a game session.</p>
   */
...
public:
  GameSession()
      : m_maximumPlayerSessionCount(0), m_gameProperties_count(0), m_port(0) {
  ...
  GameSession(const GameSession &other)
    ...
    strncpy(m_gameSessionData, other.m_gameSessionData,
            sizeof(other.m_gameSessionData));
    strncpy(m_matchmakerData, other.m_matchmakerData,
            sizeof(other.m_matchmakerData));
    strncpy(m_dnsName, other.m_dnsName, sizeof(other.m_dnsName));

    std::copy(std::begin(other.m_gameProperties),
              std::end(other.m_gameProperties), std::begin(m_gameProperties));
  }
  ...
  /**
   * The DNS name of the host running a GameLift server process, used for
   * establishing a TLS connection for a game session.
   */
