...
namespace Internal {
/**
 * WebSocketStartMatchBackfillRequest request. This request is sent to the
 * GameLift WebSocket during a DescribePlayerSessions call
 */
class WebSocketStartMatchBackfillRequest : public Message {
public:
  WebSocketStartMatchBackfillRequest();
  WebSocketStartMatchBackfillRequest(
      const WebSocketStartMatchBackfillRequest &) = default;
  WebSocketStartMatchBackfillRequest(WebSocketStartMatchBackfillRequest &&) =
      default;
  WebSocketStartMatchBackfillRequest &
  operator=(const WebSocketStartMatchBackfillRequest &) = default;
  WebSocketStartMatchBackfillRequest &
  operator=(WebSocketStartMatchBackfillRequest &&) = default;
  ~WebSocketStartMatchBackfillRequest() = default;

  inline const std::string &GetTicketId() const { return m_ticketId; }

  inline void SetTicketId(const std::string &ticketId) {
    m_ticketId = ticketId;
  }

  inline WebSocketStartMatchBackfillRequest &
  ...
  inline void SetGameSessionArn(const std::string &gameSessionArn) {
    m_gameSessionArn = gameSessionArn;
  }

  inline WebSocketStartMatchBackfillRequest &
  WithGameSessionArn(const std::string &gameSessionArn) {
  ...
  inline void SetMatchmakingConfigurationArn(
      const std::string &matchmakingConfigurationArn) {
    m_matchmakingConfigurationArn = matchmakingConfigurationArn;
  }

  inline WebSocketStartMatchBackfillRequest &WithMatchmakingConfigurationArn(
      const std::string &matchmakingConfigurationArn) {
    SetMatchmakingConfigurationArn(matchmakingConfigurationArn);
    return *this;
  }

  inline const std::vector<WebSocketPlayer> &GetPlayers() const {
    return m_players;
  }

  inline void SetPlayers(const std::vector<WebSocketPlayer> &players) {
    m_players = players;
  }

  inline WebSocketStartMatchBackfillRequest &
  WithPlayers(const std::vector<WebSocketPlayer> &players) {
    SetPlayers(players);
    return *this;
  }
  ...
  friend std::ostream &operator<<(
      std::ostream &os,
      const WebSocketStartMatchBackfillRequest &describePlayerSessionsRequest);
...
private:
  ...
  static constexpr const char *MATCHMAKING_CONFIGURATION_ARN =
