...
/**
 * ActivateGameSessionRequest Request. This request is sent to the GameLift
 * WebSocket during ActivateGameSession
 */
...
public:
  ...
  ActivateGameSessionRequest &
  operator=(const ActivateGameSessionRequest &) = default;
  ActivateGameSessionRequest &
  operator=(ActivateGameSessionRequest &&) = default;
  ...
  inline ActivateGameSessionRequest &
  ...
  friend std::ostream &operator<<(std::ostream &os,
                                  const ActivateGameSessionRequest &request);
