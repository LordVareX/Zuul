...
inline AWS_GAMELIFT_API PlayerSessionCreationPolicy
GetPlayerSessionCreationPolicyForName(const std::string &name) {
  if (name == "ACCEPT_ALL") {
...
inline AWS_GAMELIFT_API std::string
GetNameForPlayerSessionCreationPolicy(PlayerSessionCreationPolicy value) {
  switch (value) {
...
#else
inline AWS_GAMELIFT_API PlayerSessionCreationPolicy
GetPlayerSessionCreationPolicyForName(const char *name) {
...
inline AWS_GAMELIFT_API const char *
GetNameForPlayerSessionCreationPolicy(PlayerSessionCreationPolicy value) {
  switch (value) {
  case PlayerSessionCreationPolicy::ACCEPT_ALL:
    return "ACCEPT_ALL";
