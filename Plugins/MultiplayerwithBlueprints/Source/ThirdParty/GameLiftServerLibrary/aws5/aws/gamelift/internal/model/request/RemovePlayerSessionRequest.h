...
public:
  ...
  RemovePlayerSessionRequest(std::string gameSessionId,
  ...
  operator=(const RemovePlayerSessionRequest &) = default;
  RemovePlayerSessionRequest &
  operator=(RemovePlayerSessionRequest &&) = default;
  ...
  inline RemovePlayerSessionRequest &
  ...
  friend std::ostream &operator<<(std::ostream &os,
                                  const RemovePlayerSessionRequest &request);
