...
/**
 * TerminateServerProcess Request. This request is sent to the GameLift
 * WebSocket during the ProcessEnding call
 */
class TerminateServerProcessRequest : public Message {
public:
  TerminateServerProcessRequest();

  TerminateServerProcessRequest(const TerminateServerProcessRequest &) =
      default;
  TerminateServerProcessRequest(TerminateServerProcessRequest &&) = default;
  TerminateServerProcessRequest &
  operator=(const TerminateServerProcessRequest &) = default;
  TerminateServerProcessRequest &
  operator=(TerminateServerProcessRequest &&) = default;
  ~TerminateServerProcessRequest() = default;

private:
  static constexpr const char *TERMINATE_SERVER_PROCESS =
