...
namespace Internal {
/**
 * WebSocketGetComputeCertificateRequest Request. This request is sent to the
...
public:
  ...
  WebSocketGetComputeCertificateRequest(
      const WebSocketGetComputeCertificateRequest &) = default;
  WebSocketGetComputeCertificateRequest(
      WebSocketGetComputeCertificateRequest &&) = default;
  WebSocketGetComputeCertificateRequest &
  operator=(const WebSocketGetComputeCertificateRequest &) = default;
  WebSocketGetComputeCertificateRequest &
  operator=(WebSocketGetComputeCertificateRequest &&) = default;
  ~WebSocketGetComputeCertificateRequest() = default;

  friend std::ostream &operator<<(std::ostream &os,
                                  const WebSocketGetComputeCertificateRequest
