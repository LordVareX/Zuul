...
public:
  TerminateProcessMessage() : m_terminationTime(-1) {
    SetAction(TERMINATE_PROCESS);
  };
  ...
  inline TerminateProcessMessage &
  ...
  operator<<(std::ostream &os,
             const TerminateProcessMessage &terminateProcessMessage);
