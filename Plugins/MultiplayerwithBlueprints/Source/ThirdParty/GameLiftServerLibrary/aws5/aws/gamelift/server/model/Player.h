...
public:
  ...
  Player(const Player &other)
      : m_playerId(other.m_playerId), m_team(other.m_team),
  ...
  inline Player &WithPlayerId(const std::string &value) {
    SetPlayerId(value);
    return *this;
  }

  inline Player &WithPlayerId(std::string &&value) {
    SetPlayerId(value);
    return *this;
  }

  inline Player &WithPlayerId(const char *value) {
    SetPlayerId(value);
    return *this;
  }
  ...
  inline Player &WithTeam(const std::string &value) {
    SetTeam(value);
    return *this;
  }

  inline Player &WithTeam(std::string &&value) {
    SetTeam(value);
    return *this;
  }

  inline Player &WithTeam(const char *value) {
    SetTeam(value);
    return *this;
  }

  inline const std::map<std::string, AttributeValue> &
  GetPlayerAttributes() const {
    return m_playerAttributes;
  }

  inline void
  SetPlayerAttributes(const std::map<std::string, AttributeValue> &value) {
    m_playerAttributes = value;
  }

  inline void
  SetPlayerAttributes(const std::map<std::string, AttributeValue> &&value) {
    m_playerAttributes = std::move(value);
  }

  inline Player &
  WithPlayerAttributes(const std::map<std::string, AttributeValue> &value) {
    SetPlayerAttributes(value);
    return *this;
  }

  inline Player &
  WithPlayerAttributes(std::map<std::string, AttributeValue> &&value) {
    SetPlayerAttributes(value);
    return *this;
  }

  inline Player &AddPlayerAttribute(const std::string &attrName,
  ...
  inline const std::map<std::string, int> &GetLatencyInMs() const {
    return m_latencyInMs;
  }

  inline void SetLatencyInMs(const std::map<std::string, int> &value) {
    m_latencyInMs = value;
  }

  inline void SetLatencyInMs(const std::map<std::string, int> &&value) {
    m_latencyInMs = std::move(value);
  }

  inline Player &WithLatencyInMs(const std::map<std::string, int> &value) {
    SetLatencyInMs(value);
    return *this;
  }

  inline Player &WithLatencyInMs(std::map<std::string, int> &&value) {
    SetLatencyInMs(value);
    return *this;
  }

  inline Player &AddLatencyInMs(const std::string &attrName,
                                const int &attrValue) {
    m_latencyInMs[attrName] = attrValue;
    return *this;
  }
...
public:
  ...
  inline void SetPlayerId(const char *value) {
    ...
    m_playerId[MAX_PLAYER_ID_STRING_LENGTH - 1] = '\0';
  }
  ...
  inline void SetTeam(const char *value) {
    strncpy(m_team, value, sizeof(m_team));
    m_team[MAX_TEAM_STRING_LENGTH - 1] = '\0';
  }
  ...
  inline const NamedAttribute *GetPlayerAttributes(int &count) const {
    count = m_attributeCount;
    return m_playerAttributes;
  }

  inline void AddPlayerAttribute(const char *attrName,
                                 const AttributeValue &attrValue) {
    if (m_attributeCount < MAX_PLAYER_ATTRIBUTES_SIZE) {
      m_playerAttributes[m_attributeCount++] =
          NamedAttribute(attrName, attrValue);
    }
  }

  inline Player &WithPlayerAttribute(const char *attrName,
                                     const AttributeValue &attrValue) {
    AddPlayerAttribute(attrName, attrValue);
    return *this;
  }

  inline const RegionAndLatency *GetLatencyMs(int &count) const {
    count = m_latencyCount;
    return m_latencyInMs;
  }
  ...
  inline Player &WithLatencyMs(const char *region, int latencyMs) {
    AddLatencyMs(region, latencyMs);
    return *this;
  }

  struct NamedAttribute {
    NamedAttribute() { m_name[0] = 0; }

    NamedAttribute(const char *name, const AttributeValue &value)
        : m_value(value) {
    ...
    NamedAttribute(const NamedAttribute &&other)
  ...
  struct RegionAndLatency {
    RegionAndLatency() : m_latencyMs(0) { m_region[0] = 0; }
    ...
    RegionAndLatency(const RegionAndLatency &other) { *this = other; }
