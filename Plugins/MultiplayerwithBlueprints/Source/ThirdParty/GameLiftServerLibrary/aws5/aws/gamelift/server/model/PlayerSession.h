...
public:
  PlayerSession()
      : m_creationTime(0), m_terminationTime(0), m_status(), m_port(0) {}
  ...
  PlayerSession(const PlayerSession &other)
      : m_playerSessionId(other.m_playerSessionId),
        m_playerId(other.m_playerId), m_gameSessionId(other.m_gameSessionId),
        m_fleetId(other.m_fleetId), m_creationTime(other.m_creationTime),
        m_terminationTime(other.m_terminationTime), m_status(other.m_status),
        m_ipAddress(other.m_ipAddress), m_port(other.m_port),
        m_playerData(other.m_playerData), m_dnsName(other.m_dnsName) {}
   ...
   */
  inline const std::string &GetPlayerSessionId() const {
   ...
   * <p>Unique identifier for a player session.</p>
   */
  inline void SetPlayerSessionId(const std::string &value) {
    m_playerSessionId = value;
  }

  /**
   * <p>Unique identifier for a player session.</p>
   */
  inline void SetPlayerSessionId(std::string &&value) {
    m_playerSessionId = value;
  }
  ...
  inline void SetPlayerSessionId(const char *value) {
    m_playerSessionId.assign(value);
  }

  /**
   * <p>Unique identifier for a player session.</p>
   */
  inline PlayerSession &WithPlayerSessionId(const std::string &value) {
   ...
   * <p>Unique identifier for a player session.</p>
   */
  inline PlayerSession &WithPlayerSessionId(std::string &&value) {
    SetPlayerSessionId(value);
    return *this;
  }
   ...
   * <p>Unique identifier for a player session.</p>
   */
  inline PlayerSession &WithPlayerSessionId(const char *value) {
    SetPlayerSessionId(value);
    return *this;
  }
   ...
   * <p>Unique identifier for a player.</p>
   */
  inline PlayerSession &WithPlayerId(const std::string &value) {
    SetPlayerId(value);
    return *this;
  }
   ...
   * <p>Unique identifier for a player.</p>
   */
  inline PlayerSession &WithPlayerId(std::string &&value) {
    SetPlayerId(value);
    return *this;
  }
   ...
   * <p>Unique identifier for a player.</p>
   */
  inline PlayerSession &WithPlayerId(const char *value) {
    SetPlayerId(value);
    return *this;
  }

  /**
   * <p>Unique identifier for the game session that the player session is
   * connected to.</p>
   */
   ...
   * connected to.</p>
   */
  inline void SetGameSessionId(const std::string &value) {
   ...
   * connected to.</p>
   */
  inline PlayerSession &WithGameSessionId(const std::string &value) {
   ...
   * connected to.</p>
   */
  inline PlayerSession &WithGameSessionId(std::string &&value) {
    SetGameSessionId(value);
    return *this;
  }
   ...
   * connected to.</p>
   */
  inline PlayerSession &WithGameSessionId(const char *value) {
    SetGameSessionId(value);
    return *this;
  }
   ...
   * <p>Unique identifier for a fleet.</p>
   */
  inline PlayerSession &WithFleetId(const std::string &value) {
    SetFleetId(value);
    return *this;
  }
   ...
   * <p>Unique identifier for a fleet.</p>
   */
  inline PlayerSession &WithFleetId(std::string &&value) {
    SetFleetId(value);
    return *this;
  }
   ...
   * <p>Unique identifier for a fleet.</p>
   */
  inline PlayerSession &WithFleetId(const char *value) {
    SetFleetId(value);
    return *this;
  }

  /**
   * <p>Time stamp indicating when this data object was created. Format is a
   ...
   * number expressed in Unix time as milliseconds (ex: "1469498468.057".</p>
   */
  inline PlayerSession &WithCreationTime(long value) {
   ...
   * number expressed in Unix time as milliseconds (ex: "1469498468.057".</p>
   */
  inline PlayerSession &WithTerminationTime(long value) {
    SetTerminationTime(value);
    return *this;
  }

  /**
   * <p>Current status of the player session.</p> <p>Possible player session
   * statuses include the following:</p> <ul> <li> <p> <b>RESERVED</b> – The
   * player session request has been received, but the player has not yet
   * connected to the server process and/or been validated. </p> </li> <li> <p>
   * <b>ACTIVE</b> – The player has been validated by the server process and is
   * currently connected.</p> </li> <li> <p> <b>COMPLETED</b> – The player
   * connection has been dropped.</p> </li> <li> <p> <b>TIMEDOUT</b> – A player
   * session request was received, but the player did not connect and/or was not
   * validated within the time-out limit (60 seconds).</p> </li> </ul>
   */
   ...
   * validated within the time-out limit (60 seconds).</p> </li> </ul>
   */
  inline PlayerSession &WithStatus(const PlayerSessionStatus &value) {
    SetStatus(value);
    return *this;
  }
   ...
   * location.</p>
   */
  inline PlayerSession &WithIpAddress(const std::string &value) {
    SetIpAddress(value);
    return *this;
  }
   ...
   * location.</p>
   */
  inline PlayerSession &WithIpAddress(std::string &&value) {
    SetIpAddress(value);
    return *this;
  }
   ...
   * location.</p>
   */
  inline PlayerSession &WithIpAddress(const char *value) {
    SetIpAddress(value);
    return *this;
  }

  /**
   * <p>Port number for the game session. To connect to a GameLift server
   ...
   * <p>Custom player data.</p>
   */
  inline PlayerSession &WithPlayerData(const std::string &value) {
    SetPlayerData(value);
    return *this;
  }
   ...
   * <p>Custom player data.</p>
   */
  inline PlayerSession &WithPlayerData(std::string &&value) {
    SetPlayerData(value);
    return *this;
  }
   ...
   * <p>Custom player data.</p>
   */
  inline PlayerSession &WithPlayerData(const char *value) {
    SetPlayerData(value);
    return *this;
  }
   ...
   * location.</p>
   */
  inline PlayerSession &WithDnsName(const std::string &value) {
    SetDnsName(value);
    return *this;
  }
   ...
   * location.</p>
   */
  inline PlayerSession &WithDnsName(std::string &&value) {
    SetDnsName(value);
    return *this;
  }
   ...
   * location.</p>
   */
  inline PlayerSession &WithDnsName(const char *value) {
    SetDnsName(value);
    return *this;
  }
...
public:
  ...
  PlayerSession(const PlayerSession &other)
      : m_creationTime(other.m_creationTime),
        m_terminationTime(other.m_terminationTime), m_status(other.m_status),
        m_port(other.m_port) {
    strncpy(m_playerSessionId, other.m_playerSessionId,
            sizeof(other.m_playerSessionId));
    strncpy(m_playerId, other.m_playerId, sizeof(other.m_playerId));
    strncpy(m_gameSessionId, other.m_gameSessionId,
            sizeof(other.m_gameSessionId));
   ...
   * <p>Custom player data.</p>
   */
  inline void SetPlayerData(const char *value) {
    strncpy(m_playerData, value, sizeof(m_playerData));
    m_playerData[sizeof(m_playerData) - 1] = 0;
  }
