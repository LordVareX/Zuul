...
public:
  ...
  Outcome(R &&r)
      : result(std::forward<R>(r)), success(true) {} // Result move constructor
  Outcome(E &&e)
      : error(std::forward<E>(e)), success(false) {} // Error move constructor
  Outcome(const Outcome &o)
      : result(o.result), error(o.error), success(o.success) {}
  ...
  Outcome(Outcome &&o)
      : // Required to force Move Constructor
        result(std::move(o.result)), error(std::move(o.error)),
        success(o.success) {}
  ...
  /**
   * casts the underlying result to an r-value so that caller can't take
   * ownership of underlying resources. this is necessary when streams are
   * involved.
   */
...
typedef Outcome<Aws::GameLift::Server::Model::DescribePlayerSessionsResult,
                GameLiftError>
    DescribePlayerSessionsOutcome;
typedef Outcome<Aws::GameLift::Server::Model::StartMatchBackfillResult,
                GameLiftError>
    StartMatchBackfillOutcome;
typedef Outcome<Aws::GameLift::Server::Model::GetComputeCertificateResult,
                GameLiftError>
    GetComputeCertificateOutcome;
typedef Outcome<Aws::GameLift::Server::Model::GetFleetRoleCredentialsResult,
                GameLiftError>
