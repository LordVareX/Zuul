...
public:
   ...
   */
  GetComputeCertificateResult(GetComputeCertificateResult &&other) {
    *this = std::move(other);
  }
   ...
   */
  GetComputeCertificateResult &
  operator=(const GetComputeCertificateResult &other) {
    m_certificate_path = other.m_certificate_path;
    m_computeName = other.m_computeName;
    return *this;
  }
   ...
   * <p>Certificate PEM file path.</p>
   */
  inline GetComputeCertificateResult &
  WithCertificatePath(const std::string &value) {
   ...
   * <p>Compute name of this instance</p>
   */
  inline void SetComputeName(const std::string &value) {
    m_computeName = value;
  }
   ...
   * <p>Compute name of this instance</p>
   */
  inline void SetComputeName(std::string &&value) {
    m_computeName = std::move(value);
  }
   ...
   */
  inline GetComputeCertificateResult &
  WithComputeName(const std::string &value) {
...
public:
   ...
   */
  GetComputeCertificateResult(const GetComputeCertificateResult &other) {
    strncpy(m_certificate_path, other.m_certificate_path,
            sizeof(other.m_certificate_path));
