...
public:
  ...
  GetFleetRoleCredentialsResult(
      GetFleetRoleCredentialsResult &&other) noexcept {
    *this = std::move(other);
  }

  GetFleetRoleCredentialsResult &
  operator=(const GetFleetRoleCredentialsResult &other) = default;

  GetFleetRoleCredentialsResult &
  operator=(GetFleetRoleCredentialsResult &&other) noexcept {
  ...
  inline GetFleetRoleCredentialsResult &
  WithAssumedUserRoleArn(const std::string &value) {
    SetAssumedUserRoleArn(value);
    return *this;
  }

  inline GetFleetRoleCredentialsResult &
  WithAssumedUserRoleArn(std::string &&value) {
    SetAssumedUserRoleArn(std::move(value));
    return *this;
  }

  inline GetFleetRoleCredentialsResult &
  WithAssumedUserRoleArn(const char *value) {
    SetAssumedUserRoleArn(value);
    return *this;
  }
  ...
  inline GetFleetRoleCredentialsResult &
  WithAssumedRoleId(const std::string &value) {
  ...
  inline GetFleetRoleCredentialsResult &
  WithAccessKeyId(const std::string &value) {
  ...
  inline GetFleetRoleCredentialsResult &
  WithSecretAccessKey(const std::string &value) {
    SetSecretAccessKey(value);
    return *this;
  }

  inline GetFleetRoleCredentialsResult &
  WithSecretAccessKey(std::string &&value) {
  ...
  inline GetFleetRoleCredentialsResult &
  WithSessionToken(const std::string &value) {
  ...
  inline GetFleetRoleCredentialsResult &
  WithExpiration(const time_t &epochTime) {
...
public:
  GetFleetRoleCredentialsResult()
      : m_assumedUserRoleArn{'\0'}, m_assumedRoleId{'\0'},
        m_accessKeyId{'\0'}, m_secretAccessKey{'\0'},
        m_sessionToken(new char[1]{'\0'}), m_expiration(0) {}
  ...
  GetFleetRoleCredentialsResult &
  operator=(const GetFleetRoleCredentialsResult &other) {
    // Don't allow self-assignment
    if (this != &other) {
      strncpy(m_assumedUserRoleArn, other.m_assumedUserRoleArn,
              sizeof(m_assumedUserRoleArn));
      ...
      strncpy(m_secretAccessKey, other.m_secretAccessKey,
              sizeof(m_secretAccessKey));
...
private:
  ...
  // -> We strongly recommend that you make no assumptions about the maximum
  // [session token] size
  char *m_sessionToken;
  time_t m_expiration;
#endif
